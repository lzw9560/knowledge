...
- 内容源：本 Obsidian Vault（H_Reference/projects/active/知识图谱|knowledge-graph 元项目]]）
- 部署：静态托管（GitHub Pages / Cloudflare Pages）

## 与知识图谱的关系
- quartz-site 是 knowledge-graph vault 的**发布层**
- vault 本地用 H_Reference/tech-learning/tools/Obsidian|Obsidian]] 编辑，Quartz 负责生成公开站点
