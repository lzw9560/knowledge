...
- 已有 H_Reference/projects/active/Obsidian-MCP|obsidian-mcp]] 做图谱写入基础设施，可复用
...
- H_Reference/projects/backlog/增量同步自动化|增量同步自动化]] — 本项目的图谱同步部分可复用增量同步管线
...
- H_Reference/projects/backlog/增量同步自动化]]
