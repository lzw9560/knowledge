...
详细实体笔记在投研子区：[[10_Reference/investing/specs/a-Plate-Sentinel项目|a-Plate-Sentinel]]。
...
- 数据源：与 [[10_Reference/projects/active/Vibe-Research|Vibe-]] 共享（[[10_Reference/investing/data-sources/AkShare|AkShare]] / [[10_Reference/investing/data-sources/东财 push2|东财]] 等）

## 与 Vibe-Research 的关系
- 定位差异：Vibe-Research = 单点深查，A-Plate-Sentinel = 全市场广扫
- 数据共享：共用 4 数据源（mootdx / 东财 / 新浪 / 同花顺）
- 情绪互通：A-Plate-Sentinel 的板块情绪可喂给 Vibe-Research 的 [[10_Reference/market_sentiment/情绪仪表盘|情绪仪表盘]]
