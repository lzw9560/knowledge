...
- 与 H_Reference/tech-learning/architecture/清洁架构|清洁架构]] 同源——代码层的清洁是架构层清洁的基础
...
- [[10_Reference/investing/specs/S006-系统重写纲领|S006 系统重写纲领]] 即遵循清洁代码 + H_Reference/tech-learning/architecture/清洁架构|清洁架构]] 重写
...
- H_Reference/tech-learning/concepts/类型安全]]
