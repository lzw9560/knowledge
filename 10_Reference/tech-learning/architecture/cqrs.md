...
- 与 [[10_Reference/tech-learning/architecture/clean-architecture|清洁架构]] 互补：CQRS 把"读"和"写"彻底分离，清洁架构只分层不分离读写
...
## 与事件驱动的天然搭配
- CQRS 常配 [[10_Reference/tech-learning/architecture/event-driven|事件驱动]]：写模型发事件，读模型订阅事件更新物化视图
