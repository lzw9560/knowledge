...
- 演进：三层架构 → N 层架构 → H_Reference/tech-learning/architecture/清洁架构|清洁架构]] → 六边形架构
...
## 与清洁架构的对比
- 分层架构：上下依赖，层是横向切分
- H_Reference/tech-learning/architecture/清洁架构|清洁架构]]：同心圆分层，依赖方向由外向内——更强调"领域核心独立"
...
- H_Reference/tech-learning/architecture/六边形架构]]
