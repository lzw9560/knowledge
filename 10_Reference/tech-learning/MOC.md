...
- [[10_Reference/tech-learning/tools/uv]] — uv：Python 包管理器/Vibe-Research 用
...
- [[10_Reference/tech-learning/tools/obsidian-git]] — obsidian-git：Obsidian git 同步插件
- [[10_Reference/tech-learning/tools/cron]] — cron：定时任务

### 架构
- [[10_Reference/tech-learning/architecture/event-driven]] — 事件驱动：S011 调度收口参考
- [[10_Reference/tech-learning/architecture/clean-architecture]] — 清洁架构：分层模式/S006 系统重写参考
- [[10_Reference/tech-learning/architecture/layered-architecture]] — 分层架构：经典 N 层/S006 重写纲领参考
- [[10_Reference/tech-learning/architecture/microservices]] — 微服务：S011 调度收口边界参考
- [[10_Reference/tech-learning/architecture/event-sourcing]] — 事件溯源：工作流状态机参考
- [[10_Reference/tech-learning/architecture/cqrs]] — CQRS：命令查询职责分离/S007 契约层读路径参考
- [[10_Reference/tech-learning/architecture/hexagonal]] — 六边形架构：端口适配器/数据源抽象参考
