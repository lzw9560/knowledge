...
| 架构 | [[architecture/]] | 8 | 架构模式（事件驱动/清洁架构/分层架构/微服务/事件溯源 + CQRS/六边形/Saga） |
| 概念 | [[concepts/]] | 6 | 编程概念（async-await/类型安全/清洁代码/依赖注入/熔断器/缓存策略） |
...
- [[architecture/layered-architecture]] — 分层架构：经典 N 层/S006 重写纲领参考
...
- [[concepts/dependency-injection]] — 依赖注入：IoC 实现/S015 config 拆分参考
- [[concepts/circuit-breaker]] — 熔断器：容错模式/S022 防封熔断参考
- [[concepts/caching-strategy]] — 缓存策略：性能优化/S004 性能优化参考
