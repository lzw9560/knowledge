...
### 工具
- H_Reference/tech-learning/tools/Docker]] — Docker：容器化
- H_Reference/tech-learning/tools/Git]] — Git：版本控制
- H_Reference/tech-learning/tools/uv包管理]] — uv：Python 包管理器/Vibe-Research 用
- H_Reference/tech-learning/tools/Obsidian]] — Obsidian：知识管理工具/本 vault 用
- H_Reference/tech-learning/tools/Docker-Compose]] — Docker Compose：多容器编排
- H_Reference/tech-learning/tools/GitHub-Actions]] — GitHub Actions：CI/CD
- H_Reference/tech-learning/tools/Obsidian-Git插件]] — obsidian-git：Obsidian git 同步插件
- H_Reference/tech-learning/tools/定时任务]] — cron：定时任务

### 架构
- H_Reference/tech-learning/architecture/事件驱动架构]] — 事件驱动：S011 调度收口参考
- H_Reference/tech-learning/architecture/清洁架构]] — 清洁架构：分层模式/S006 系统重写参考
- H_Reference/tech-learning/architecture/分层架构]] — 分层架构：经典 N 层/S006 重写纲领参考
- H_Reference/tech-learning/architecture/微服务架构]] — 微服务：S011 调度收口边界参考
- H_Reference/tech-learning/architecture/事件溯源]] — 事件溯源：工作流状态机参考
- [[10_Reference/tech-learning/architecture/cqrs]] — CQRS：命令查询职责分离/S007 契约层读路径参考
- H_Reference/tech-learning/architecture/六边形架构]] — 六边形架构：端口适配器/数据源抽象参考
...
- H_Reference/tech-learning/concepts/类型安全]] — 类型安全：静态类型/S007 Pydantic 契约参考
- H_Reference/tech-learning/concepts/清洁代码]] — 清洁代码：代码层清洁/S006 重写参考
- H_Reference/tech-learning/concepts/依赖注入]] — 依赖注入：IoC 实现/S015 config 拆分参考
- H_Reference/tech-learning/concepts/熔断器]] — 熔断器：容错模式/S022 防封熔断参考
- H_Reference/tech-learning/concepts/缓存策略]] — 缓存策略：性能优化/S004 性能优化参考

## 与投研的跨领域链接

> 跨域链接判据遵循 H_Reference/investing/logic/跨域门控]]（待建）：跨域实体必须有 ≥ 2 个具体实例 + 1 条 invariant，否则不建。

- H_Reference/investing/data-sources/AkShare|akshare]] — 数据源库，技术学习 + 投研共享
- [[10_Reference/investing/specs/archive/m0-foundation/S008-后端数据层迁移|S008 后端数据层迁移]] — 架构决策，技术学习参考
- H_Reference/meta/四构件本体方法论|四构件本体]] — 通用方法论，本子区同样遵循

## 关联子区

- H_Reference/projects/active/Vibe-Research]] — Vibe-Research 项目追踪（技术栈详情）
- H_Reference/projects/active/TradingAgents]] — TradingAgents 项目追踪
