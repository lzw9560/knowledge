...
## 类别
- GitHub 原生 CI/CD 平台
- 与 [[10_Reference/[[tech-learning/tools/Git|Git]][[Git]] 同源：commit/push 即触发
...
- 配合 [[10_Reference/[[tech-learning/tools/定时任务|定时任务]][[cron]]：GitHub Actions 的 `schedule` 触发器是托管态 cron
