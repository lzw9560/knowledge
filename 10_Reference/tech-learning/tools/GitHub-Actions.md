...
## 类别
- GitHub 原生 CI/CD 平台
- 与 H_Reference/tech-learning/tools/Git|Git]] 同源：commit/push 即触发
...
- **quartz-deploy workflow**：H_Reference/projects/active/Quartz部署|Quartz 站点]] 自动部署
- 配合 H_Reference/tech-learning/tools/定时任务|cron]]：GitHub Actions 的 `schedule` 触发器是托管态 cron

## 相关链接
- [[10_Reference/tech-learning/MOC]]
- H_Reference/tech-learning/tools/Git]]
- H_Reference/tech-learning/tools/定时任务]]
- H_Reference/projects/active/Quartz部署]]
