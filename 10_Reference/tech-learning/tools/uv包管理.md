...
- 投研数据源 SDK 安装：H_Reference/investing/data-sources/AkShare|akshare]] / mootdx 等 Python 包由 uv 统一管理与锁版本
- 与 H_Reference/tech-learning/tools/Docker|Docker]] 配合：Dockerfile 中用 `uv sync --frozen` 做可复现构建
