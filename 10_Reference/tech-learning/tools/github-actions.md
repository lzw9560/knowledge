...
- **quartz-deploy workflow**：[[10_Reference/projects/active/quartz-deploy|Quartz 站点]] 自动部署
- 配合 [[10_Reference/tech-learning/tools/cron|cron]]：GitHub Actions 的 `schedule` 触发器是托管态 cron

## 相关链接
- [[10_Reference/tech-learning/MOC]]
- [[10_Reference/tech-learning/tools/git]]
- [[10_Reference/tech-learning/tools/cron]]
- [[10_Reference/projects/active/quartz-deploy]]
