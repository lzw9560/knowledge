...
- 🔧 [[10_Reference/[[tech-learning/concepts/数据契约|数据契约]][[数据契约]] — 宏观 7 系列（DEC-002 定稿）由 Pydantic 契约层统一形状
- 🔧 [[10_Reference/[[tech-learning/concepts/优雅降级|优雅降级]][[优雅降级]] — FRED 宏观无降级，失败标灰
- 🔧 [[10_Reference/[[tech-learning/concepts/缓存策略|缓存策略]][[缓存策略]] — 宏观数据低频，入缓存降低请求
