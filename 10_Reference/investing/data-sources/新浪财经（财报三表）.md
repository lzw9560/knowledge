...
- 🔧 H_Reference/tech-learning/concepts/优雅降级|优雅降级]] — 新浪财报三表无降级，失败标灰
- 🔧 H_Reference/tech-learning/concepts/数据契约|数据契约]] — 财报三表数据由契约层统一形状
- 🔧 H_Reference/tech-learning/concepts/缓存策略|缓存策略]] — 财报低频数据入缓存
