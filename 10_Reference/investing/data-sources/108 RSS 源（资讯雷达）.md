...
- 🔧 [[10_Reference/[[tech-learning/concepts/优雅降级|优雅降级]][[优雅降级]] — 108 源单源失败不拖垮整体，聚合层容错
- 🔧 [[10_Reference/[[tech-learning/concepts/熔断器|熔断器]][[熔断器]] — 单源连续失败可加熔断
- 🔧 [[10_Reference/[[tech-learning/concepts/缓存策略|缓存策略]][[缓存策略]] — 资讯入缓存降低重复抓取
