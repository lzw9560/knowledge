...
- 🏗️ [[10_Reference/tech-learning/architecture/分层架构|分层架构]] — 重写纲领的核心架构决策：routers → services → domain → repositories
- 🏗️ [[10_Reference/tech-learning/architecture/清洁架构|清洁架构]] — 领域核心独立，依赖反转
- 🔧 [[10_Reference/tech-learning/concepts/数据契约|数据契约]] — 纲领 §5 第 1 步即契约层（S007）
