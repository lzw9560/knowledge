...
- 🔧 [[10_Reference/[[tech-learning/concepts/数据契约|数据契约]][[数据契约]] — 语义吸收即把裸 dict + 魔法字符串吸收为 Pydantic 契约模型
- 🔧 [[10_Reference/[[tech-learning/frameworks/pydantic|Pydantic]] — 4 阶段框架用 Pydantic 做形状统一
- 🏗️ [[10_Reference/[[tech-learning/architecture/分层架构|分层架构]][[分层架构]] — 吸收过程遵循分层，不跨层泄漏
