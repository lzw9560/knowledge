...
- 相关 spec：[[specs/archive/m2-closed-loop/S064-盯盘教练MVP]]（W-C 盯盘教练 MVP） / [[specs/archive/m3-strategy/S066-策略特定漏斗架构重构]]（天气熔断） / [[specs/archive/m1-workflow/S042-统一持仓建议引擎]]（持仓建议引擎）
