...
- [[10_Reference/market_sentiment/DASHBOARD]] — 情绪子区 MOC（带 6 层 z-score + 三维向量 + 仓位映射）
- [[10_Reference/meta/PARA-method]] — PARA 方法论（与 MOC 互补的横向分层）
